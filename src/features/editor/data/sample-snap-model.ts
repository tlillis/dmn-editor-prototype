...
then Medical Expenses - MEDICAL_EXPENSE_THRESHOLD
  ...
  testCases: [
    // ============================================
    // PASSING TEST CASES - Expected to pass
    // ============================================
    {
      id: 'test_eligible_single_low_income',
      name: 'Eligible: Single, Low Income',
      createdAt: Date.now(),
      updatedAt: Date.now(),
      inputs: {
        householdSize: 1,
        ...
        medicalExpenses: 0,
        isUSCitizen: true,
        isQualifiedNoncitizen: false,
        livesInColorado: true,
        hasSSN: true,
        registeredForWork: true,
        applicantAge: 35,
        hasDependents: false,
        isStudent: false,
        studentMeetsExemption: false,
        meetsABAWDWorkRequirement: true,
        isFleeingFelon: false,
        violatedProbationOrParole: false,
      },
      expectations: [
        {
          nodeId: 'snapEligible',
          nodeName: 'SNAP Eligible',
          expectedValue: true,
        },
        {
          nodeId: 'grossIncomeTest',
          nodeName: 'Gross Income Test',
          expectedValue: true,
        },
        {
          nodeId: 'netIncomeTest',
          nodeName: 'Net Income Test',
          expectedValue: true,
        },
        {
          nodeId: 'benefitAmount',
          nodeName: 'Benefit Amount',
          expectedValue: 203.8,
        },
      ],
    },
    {
      id: 'test_eligible_family_of_four',
      name: 'Eligible: Family of 4',
      createdAt: Date.now(),
      updatedAt: Date.now(),
      inputs: {
        householdSize: 4,
      ...
      expectations: [
        ...
        {
          nodeId: 'standardDeduction',
          nodeName: 'Standard Deduction',
          expectedValue: 217,
        },
        {
          nodeId: 'earnedIncomeDeduction',
          nodeName: 'Earned Income Deduction',
          expectedValue: 500,
        },
      ],
    },
    {
      id: 'test_eligible_elderly_high_medical',
      name: 'Eligible: Elderly with Medical',
      createdAt: Date.now(),
      updatedAt: Date.now(),
      inputs: {
        householdSize: 2,
      ...
      expectations: [
        ...
        {
          nodeId: 'medicalDeduction',
          nodeName: 'Medical Deduction',
          expectedValue: 165,
        },
        { nodeId: 'isABAWD', nodeName: 'Is ABAWD', expectedValue: false },
      ],
    },
    {
      id: 'test_eligible_homeless',
      name: 'Eligible: Homeless Individual',
      createdAt: Date.now(),
      updatedAt: Date.now(),
      inputs: {
        householdSize: 1,
      ...
      expectations: [
        ...
        {
          nodeId: 'excessShelterDeduction',
          nodeName: 'Excess Shelter Deduction',
          expectedValue: 190.3,
        },
        {
          nodeId: 'benefitAmount',
          nodeName: 'Benefit Amount',
          expectedValue: 290.29,
        },
      ],
    },
    {
      id: 'test_eligible_qualified_noncitizen',
      name: 'Eligible: Qualified Noncitizen',
      createdAt: Date.now(),
      updatedAt: Date.now(),
      inputs: {
        householdSize: 3,
        ...
        earnedIncome: 2000,
        dependentCareCosts: 100,
        shelterCosts: 800,
        childSupportPaid: 0,
        medicalExpenses: 0,
        isUSCitizen: false,
        isQualifiedNoncitizen: true,
        livesInColorado: true,
        hasSSN: true,
        registeredForWork: true,
        applicantAge: 32,
      ...
      expectations: [
        {
          nodeId: 'citizenshipRequirementMet',
          nodeName: 'Citizenship Requirement Met',
          expectedValue: true,
        },
        {
          nodeId: 'snapEligible',
    ...
    {
      id: 'test_eligible_student_with_exemption',
      name: 'Eligible: Student with Exemption',
      createdAt: Date.now(),
      updatedAt: Date.now(),
      inputs: {
        householdSize: 1,
      ...
      expectations: [
        {
          nodeId: 'studentEligibilityMet',
          nodeName: 'Student Eligibility Met',
          expectedValue: true,
        },
        {
          nodeId: 'snapEligible',
    ...
    // ============================================
    // INELIGIBLE TEST CASES - Expected to fail eligibility
    // ============================================
    {
      id: 'test_ineligible_income_too_high',
      name: 'Ineligible: Income Too High',
      createdAt: Date.now(),
      updatedAt: Date.now(),
      inputs: {
        householdSize: 2,
    ...
    {
      id: 'test_ineligible_not_citizen',
      name: 'Ineligible: Not a Citizen',
      createdAt: Date.now(),
      updatedAt: Date.now(),
      inputs: {
        householdSize: 1,
      ...
      expectations: [
        ...
        {
          nodeId: 'nonFinancialRequirementsMet',
          nodeName: 'Non Financial Requirements Met',
          expectedValue: false,
        },
        {
          nodeId: 'snapEligible',
    ...
    {
      id: 'test_ineligible_abawd_no_work',
      name: 'Ineligible: ABAWD Not Working',
      createdAt: Date.now(),
      updatedAt: Date.now(),
      inputs: {
        householdSize: 1,
        ...
        isStudent: false,
        studentMeetsExemption: false,
        meetsABAWDWorkRequirement: false,
        isFleeingFelon: false,
        violatedProbationOrParole: false,
      },
      expectations: [
        { nodeId: 'isABAWD', nodeName: 'Is ABAWD', expectedValue: true },
        {
          nodeId: 'abawdRequirementMet',
          nodeName: 'ABAWD Requirement Met',
          expectedValue: false,
        },
        {
          nodeId: 'snapEligible',
    ...
    {
      id: 'test_ineligible_student_no_exemption',
      name: 'Ineligible: Student No Exemption',
      createdAt: Date.now(),
      updatedAt: Date.now(),
      inputs: {
        householdSize: 1,
    ...
    {
      id: 'test_ineligible_fleeing_felon',
      name: 'Ineligible: Fleeing Felon',
      createdAt: Date.now(),
      updatedAt: Date.now(),
      inputs: {
        householdSize: 1,
      ...
      expectations: [
        {
          nodeId: 'notDisqualified',
          nodeName: 'Not Disqualified',
          expectedValue: false,
        },
        {
          nodeId: 'snapEligible',
    ...
    // ============================================
    // INTENTIONALLY FAILING TESTS - Wrong expectations for demo
    // ============================================
    {
      id: 'test_fail_wrong_benefit',
      name: 'FAIL DEMO: Wrong Benefit Amount',
      createdAt: Date.now(),
      updatedAt: Date.now(),
      inputs: {
        householdSize: 1,
      ...
      expectations: [
        ...
        // Wrong! Actual benefit should be 292 (max for household of 1)
        {
          nodeId: 'benefitAmount',
          nodeName: 'Benefit Amount',
          expectedValue: 500,
    ...
    {
      id: 'test_fail_wrong_eligibility',
      name: 'FAIL DEMO: Wrong Eligibility',
      createdAt: Date.now(),
      updatedAt: Date.now(),
      inputs: {
        householdSize: 2,
      ...
      expectations: [
        // Wrong! Income is way over limit, should be false
        {
          nodeId: 'grossIncomeTest',
          nodeName: 'Gross Income Test',
          expectedValue: true,
    ...
    {
      id: 'test_fail_wrong_deduction',
      name: 'FAIL DEMO: Wrong Deduction',
      createdAt: Date.now(),
      updatedAt: Date.now(),
      inputs: {
        householdSize: 3,
      ...
      expectations: [
        // Wrong! Standard deduction for 3 people is 204, not 300
        {
          nodeId: 'standardDeduction',
          nodeName: 'Standard Deduction',
          expectedValue: 300,
        },
        // Wrong! Earned income deduction should be 400 (20% of 2000)
        {
          nodeId: 'earnedIncomeDeduction',
          nodeName: 'Earned Income Deduction',
          expectedValue: 500,
